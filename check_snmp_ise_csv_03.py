...
# InsecureRequestWarning deaktivieren
...
def check_snmp_config(device_id):
    ...
    try:
        ...
        # IP Address Handling
        ip_list = device_data.get("NetworkDeviceIPList", [])
        ip_address = ip_list[0]["ipaddress"] if ip_list else "Keine IP"
        ...
        return device_name, ip_address, snmp_status
...
def write_to_csv(data):
    ...
    try:
        with open(CSV_FILE, mode='w', newline='') as file:
            ...
            writer.writerow(["Device Name", "IP Address", "SNMP Status"])
...
def main():
    ...
    for device in devices:
        ...
        if device_info:
            device_name, ip_address, snmp_status = device_info

            if "Kein SNMP" in snmp_status:
